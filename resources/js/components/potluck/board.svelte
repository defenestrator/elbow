	...
	<div class="mainSquare">
		...
		<div class="row top">
			<div class="square2" id="10">
				<span class="corner corner4" style="line-height:18px; margin:3.5em 0 0 1.5em"> Hospital: <br>lose a
					turn. pay 100x your roll</span>
			</div>
...
onMount(() => {
	console.log("the board has mounted");
});
...
function moveCash(amount, player) {
